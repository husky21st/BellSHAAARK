...
class Env(object):
    ...
    def reset(self):
        ...
        '''
        self.action_recorder = []
        state, player_id = self.game.init_game(self.action_recorder)
    ...
    def step(self, action, raw_action=False):
        ...
        next_state, player_id = self.game.step(action, self.action_recorder)
    ...
    def run(self, is_training=False):
        ...
        #     f.write(str(len(self.action_recorder)) + '\n')
    ...
    def seed(self, seed=None):
        ...
        return seed
        # import random
        # self.np_random, seed = seeding.np_random(random.randint(9, 99999))
        # self.game.np_random = self.np_random
        # return seed
